...
class _LoginScreenState extends State<LoginScreen> {
  ...
  AppText _buildLoginToAccount() {
    return AppText(
      translation: AppStrings.loginToYourAccount,
  ...
  Widget _buildFacebookButton() {
    return AppButton(
      translation: AppStrings.continueWithFacebook,
  ...
  Widget _buildHaveAccount() {
    return InkWell(
      onTap: () => pushName(context, AppRoute.signUp),
      child: AppText(
